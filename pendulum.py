...
att = turtle.Turtle() # to show magnitude and direction of at
att.shape('circle')
att.color('red')
...
while True:
    ...
    pen.write(" theta (rad) = {:.3f}\t at = {:.2f}\tUg: {:.2f}\tKE: {:.2f}".format(theta,at,Ug,KE), align='left', font=('Courier',15,'normal'))
    win.update()
